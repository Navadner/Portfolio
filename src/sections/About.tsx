          ...
          <div className="space-y-8">
            <div className="prose prose-lg dark:prose-invert">
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-lg">
                ...
                , and core computer science principles, I am passionate about
                leveraging technology to build intelligent and efficient
                solutions. My hands-on experience in model deployment, data
                analysis, and creating end-to-end applications fuels my ambition
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-xl border border-blue-200 dark:border-blue-800">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm">
                  Applying AI/ML models to structured datasets and developing
              ...
              <div className="bg-indigo-50 dark:bg-indigo-900/20 p-6 rounded-xl border border-indigo-200 dark:border-indigo-800">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm">
                  To secure a challenging role as an AI/ML Engineer and
                  contribute to innovative, data-driven products.
                </p>
              </div>
            </div>
