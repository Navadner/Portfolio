...
const Hero: React.FC = () => {
  ...
  const downloadResume = () => {
    ...
    // Corrected the path to use forward slashes and be relative to the root
    link.href = '/images/Navadeep_Narasamsetty_resume.pdf';
    link.download = 'Navadeep_Narasamsetty_Resume.pdf';
    link.click();
  };
      ...
      <div className="text-center max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 dark:text-white mb-4">
            <span className="block">Navadeep</span>
            <span className="block text-blue-600 dark:text-blue-400">Narasamsetty</span>
          </h1>
          ...
          <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto mb-8 leading-relaxed">
            A passionate B.Tech student specializing in AI/ML, building scalable applications, and solving complex problems.
          </p>
        </div>
